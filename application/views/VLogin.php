...
<head>
  ...
  <title>Login - SMSK (Surat Masuk Surat Keluar)</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  <img src="assets/img/logoptakecil.png" alt="">
                  <span class="d-none d-lg-block">PTA Bengkulu</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="<?php echo base_url('Login/auth') ?>" method="POST" class="row g-3 needs-validation">
